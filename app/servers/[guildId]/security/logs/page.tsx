...
type ServersSecurityLogsPageProps = {
  params: Promise<{
    guildId: string;
  }>;
};
...
export default async function ServersSecurityLogsPage({
  params,
}: ServersSecurityLogsPageProps) {
  ...
  return (
    <ServersWorkspace
      ...
      initialTab="settings"
      initialSettingsSection="security_logs"
    />
  );
}
