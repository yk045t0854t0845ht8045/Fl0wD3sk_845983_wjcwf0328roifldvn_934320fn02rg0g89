...
type ServersEntryExitOverviewPageProps = {
  params: Promise<{
    guildId: string;
  }>;
};
...
export default async function ServersEntryExitOverviewPage({
  params,
}: ServersEntryExitOverviewPageProps) {
  ...
  return (
    <ServersWorkspace
      ...
      initialTab="settings"
      initialSettingsSection="entry_exit_overview"
    />
  );
}
